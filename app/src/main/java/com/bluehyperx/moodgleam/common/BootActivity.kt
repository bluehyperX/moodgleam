...
class BootActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        @JvmStatic
        fun startMusicRecorder(context: Context, resultCode: Int, data: Intent) {
            val intent = Intent(context, ScreenGrabberService::class.java)
            intent.action = ScreenGrabberService.ACTION_START_MUSIC
            intent.putExtra(ScreenGrabberService.EXTRA_RESULT_CODE, resultCode)
            intent.putExtra(ScreenGrabberService.EXTRA_RESULT_DATA, data)
            startForegroundServiceCompat(context, intent)
        }
        ...
        @JvmStatic
        fun startEffectsRecorder(context: Context) {
            val intent = Intent(context, ScreenGrabberService::class.java)
            intent.action = ScreenGrabberService.ACTION_START_EFFECTS
            startForegroundServiceCompat(context, intent)
        }
