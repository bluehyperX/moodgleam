...
class AppOptions(
    ...
    fun refreshBorderSettings(prefs: Preferences) {
        borderDetectionEnabled = prefs.getBoolean(
            com.bluehyperx.moodgleam.R.string.pref_key_border_detection_enabled,
            false
        )
        borderThreshold =
            prefs.getInt(com.bluehyperx.moodgleam.R.string.pref_key_border_threshold, 18)
                .coerceIn(0, 64)
        borderCheckIntervalFrames = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_border_check_interval,
            60
        )
            .coerceIn(1, 300)
    }
    ...
    fun refreshColorSettings(prefs: Preferences) {
        brightness = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_color_brightness,
            100
        )
        contrast =
            prefs.getInt(com.bluehyperx.moodgleam.R.string.pref_key_color_contrast, 100)
        blackLevel =
            prefs.getInt(com.bluehyperx.moodgleam.R.string.pref_key_color_black_level, 0)
        whiteLevel = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_color_white_level,
            100
        )
        saturation = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_color_saturation,
            100
        )
        colorProcessingEnabled = prefs.getBoolean(
            com.bluehyperx.moodgleam.R.string.pref_key_color_processing_enabled,
            true
        )
        brightnessR = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_color_brightness_r,
            100
        )
        brightnessG = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_color_brightness_g,
            100
        )
        brightnessB = prefs.getInt(
            com.bluehyperx.moodgleam.R.string.pref_key_color_brightness_b,
            100
        )
        gammaR =
            prefs.getInt(com.bluehyperx.moodgleam.R.string.pref_key_color_gamma_r, 100)
        gammaG =
            prefs.getInt(com.bluehyperx.moodgleam.R.string.pref_key_color_gamma_g, 100)
        gammaB =
            prefs.getInt(com.bluehyperx.moodgleam.R.string.pref_key_color_gamma_b, 100)
    }
