...
import com.bluehyperx.moodgleam.common.util.UsbRootPermissionHelper.grantPermissionViaRootAsync
...
object UsbRootPermissionHelper {
    ...
    private fun grantSingleDevice(context: Context, deviceName: String, uid: Int): Boolean {
        ...
        val cmd = "CLASSPATH=$apkPath app_process /system/bin " +
                "com.bluehyperx.moodgleam.common.util.UsbPermissionGranterCli " +
                "$deviceName $uid"
