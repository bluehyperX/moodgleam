...
import com.bluehyperx.moodgleam.common.network.DeviceDetector
import com.bluehyperx.moodgleam.common.network.DeviceScanner
...
fun DeviceScanDialog(
    onDismiss: () -> Unit,
    targetDeviceType: DeviceDetector.DeviceType? = null,
    ...
    fun startScan() {
        ...
        scope.launch {
            withContext(Dispatchers.IO) {
                ...
                val newScanner = DeviceScanner(targetDeviceType = targetDeviceType) { device ->
...
private fun DeviceItem(
    ...
    val deviceTypeName = when (device.type) {
        ...
        DeviceDetector.DeviceType.WIZ -> stringResource(R.string.scanner_device_wiz)
